...
/**
 * Provides the local service interface for Dservice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Rishikesh Dubey
 * @see DserviceLocalServiceUtil
...
public interface DserviceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DserviceLocalServiceUtil} to access the dservice local service. Add custom service methods to {@link com.liferay.aaa.data.service.impl.DserviceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
